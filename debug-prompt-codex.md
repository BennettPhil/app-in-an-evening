...
Use this template when something is broken and you want Codex to investigate it. Copy the template, fill in the parts in square brackets `[like this]`, and paste it into Codex.
